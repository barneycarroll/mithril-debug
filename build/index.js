(function () {
	...
	function on( el, key, handler, capture ){
	       var i = arguments.length, argsArray = Array(i);
	       while ( i-- ) argsArray[i] = arguments[i];
	       if ( capture === void 0 ) capture = false;

	       if( el instanceof Array ){
	    var offs = [].concat( argsArray ).map( function (x) { return on.apply( void 0, x ); } )

	    return function () { return offs.map( function (x) { return x(); } ); }
	  }
	  else if( typeof key === 'string' ){
	    if( key.match( /\s+/ ) )
	      return key.split( /\s+/ ).map( function (key) { return on( el, key, handler, capture ); }
	      )

	    el.addEventListener( key, handler, capture )

	    return function () { return el.removeEventListener( key, handler, capture ); }
	  }
	  else {
	    var offs$1 = []
	    var hash = key

	    for( var key$1 in hash )
	      if( hash.hasOwnProperty( key$1 ) )
	        offs$1.push( on( el, key$1, hash[ key$1 ], capture ) )

	    return function () { return offs$1.map( function (x) { return x(); } ); }
	  }
	}
	...
	function dragon ( el, ref ) {
	  var ref_drag = ref.drag, drag = ref_drag === void 0 ? noop : ref_drag;
	  var ref_drop = ref.drop, drop = ref_drop === void 0 ? noop : ref_drop;
	  var ref_start = ref.start, start = ref_start === void 0 ? noop : ref_start;
	...
	var widget = {
	  controller : function(){
	    ...
	    Object.assign( this, {
	      ...
	      hover : function (e) {
	        ...
	        this$1.shadow = locate( e.pageX, e.pageY )
	      ...
	      place : function (e) {
	        ...
	        this$1.controls = [].concat( this$1.shadow )
	  ...
	  view : function (ctrl) { return m( '.Widget', {
	      ...
	      m( '.controls', {
	        style : Object.assign({}, styles.controls,
	          ( ctrl.controls[ 0 ] ? { right  : 0 } : { left : 0 } ),
	          ( ctrl.controls[ 1 ] ? { bottom : 0 } : { top  : 0 } ))
	      },
	        m( '.handle', {
	          config: function config$1( el, init, ctxt ){
	        ...
	        m( '.loupe', {
	          ...
	          style : Object.assign({}, styles.loupe,
	      ...
	      m( '.shadow', {
	        style : Object.assign({}, styles.shadow,
